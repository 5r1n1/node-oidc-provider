...
const DEFAULTS = {
  ...
  features: {
     ...
     *
     * Note: Browsers blocking access to cookies from a third party context hinder the reliability
     * of this standard.
     */
    frontchannelLogout: {
      enabled: false,
     ...
     * features.ropc
     *
     * title: [RFC6749](https://tools.ietf.org/html/rfc6749) - The OAuth 2.0 Authorization Framework
     *
     * description: Enables ROPC - Resource Owner Password Credentials flow
     *
     * customized by Srinivas Gopalakrishnan (5r1n1)
     *
     */
    ropCredentials: { enabled: false },
     ...
     *
     * Note: Browsers blocking access to cookies from a third party context hinder the reliability
     * of `response_mode=web_message` "no prompt" mode.
     *
